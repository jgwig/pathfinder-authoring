		...
		<div className="bg-moray-theme text-white rounded-3xl p-8 gap-8 flex flex-col items-center max-w-full shadow-md  relative">
			...
			<div>
				...
				<div className="text-center">
					<div className="text-[2.5rem] font-bold tracking-widest">00:12</div>
					<div className="text-white text-lg font-bold text-center my-0">
						Reps: 13
					</div>
					<p className="">
						Tap on the circle to count or count in your head and enter on the
						next screen
					</p>
				</div>
			</div>
