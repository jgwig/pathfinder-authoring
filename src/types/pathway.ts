...
import { CriteriaNodeData } from "@/nodes/criteria-node";

/**
 * Union type for all node data types in the pathway
 */
export type PathwayNodeData = StageNodeData | CriteriaNodeData;

/**
 * Typed version of ReactFlow's JSON object structure for Pathway storage
 * This is what gets stored in PayloadCMS
 */
